...
class IndexCacheTtlProviderSpec extends ObjectBehavior
{
     ...
     */
    public function it_sets_ttl_to_one_hour_when_no_best_subtitles($index)
    {
     ...
     */
    public function it_sets_ttl_to_two_hours_when_best_subtitles_with_zero_or_negative_rating($index, $subtitle)
    {
     ...
     * @param \BD\Subber\ReleaseSubtitles\TestedSubtitle $subtitle
     */
    public function it_sets_ttl_to_one_half_day_when_best_subtitle_with_positive_rating($index, $subtitle)
    {
        $index->hasBestSubtitle()->willReturn(true);
        $index->getBestSubtitle()->willReturn($subtitle);
