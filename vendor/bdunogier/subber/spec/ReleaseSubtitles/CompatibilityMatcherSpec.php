...
class CompatibilityMatcherSpec extends ObjectBehavior
{
    ...
    public function it_marks_as_incompatible_subtitles_with_a_known_source_different_from_the_release()
    {
    ...
    public function it_marks_as_incompatible_subtitles_with_a_resolution_and_a_known_group_different_from_the_release()
    {
    ...
    public function it_marks_as_incompatible_non_repacked_subtitles_when_applicable()
    {
    ...
    public function it_doesnt_mark_as_incompatible_hdtv_subtitles_from_a_different_group_if_no_resolution_is_set()
    {
